...
public class BinaryRelationTest {
	...
	public void BinaryRelationsAreNotEqualIfPredicatesAreNotEqual() {
		...
		BinaryPredicate bp1 = new BinaryPredicate(sourceEntityType1, "PICK_UP", destinationEntityType1, "picked up");
		BinaryPredicate bp2 = new BinaryPredicate(sourceEntityType2, "PICK_UP2", destinationEntityType2, "picked up");
	...
	public void CloneReturnsEqualBinaryRelation() {
		...
		BinaryPredicate predicateRoverisAtWaypoint = new BinaryPredicate(entityTypeRover, "IS_AT", entityTypeWaypoint, "is at");
